        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
                ...
                <div class="space-y-6 text-lg text-gray-700 leading-relaxed">
                    <p>
                        Founded in 2022 with a simple yet powerful vision — to transform the way Indian businesses express gratitude and appreciation.
                    </p>
                    <p>
                        What started as a small team passionate about meaningful gifting has grown into one of India’s most trusted corporate gifting partners. 
                        We believe that every gift has the power to strengthen relationships and create lasting memories.
                    </p>
                    <p>
                        Today, B2B Gifts India proudly serves over 5000+ corporate clients across 18 cities, delivering not just products, but experiences that reflect the values and aspirations of the organizations we serve.
                    </p>
                </div>
            </div>
        </div>
...
<section class="py-16 md:py-24 bg-white">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="brand-promise-card p-8 bg-white border border-gray-100 rounded-3xl hover:border-[#f4a261] transition-all group">
                <div class="w-14 h-14 bg-[#f4a261]/10 text-[#f4a261] rounded-2xl flex items-center justify-center text-3xl mb-6 group-hover:scale-110 transition-transform">
                    ✨
                </div>
            ...
            <div class="brand-promise-card p-8 bg-white border border-gray-100 rounded-3xl hover:border-[#2ec4b6] transition-all group">
                <div class="w-14 h-14 bg-[#2ec4b6]/10 text-[#2ec4b6] rounded-2xl flex items-center justify-center text-3xl mb-6 group-hover:scale-110 transition-transform">
                    🎨
                </div>
            ...
            <div class="brand-promise-card p-8 bg-white border border-gray-100 rounded-3xl hover:border-[#e07a5f] transition-all group">
                <div class="w-14 h-14 bg-[#e07a5f]/10 text-[#e07a5f] rounded-2xl flex items-center justify-center text-3xl mb-6 group-hover:scale-110 transition-transform">
                    🤝
                </div>
            ...
            <div class="grid md:grid-cols-2">
                ...
                <div class="p-4 md:p-16 flex flex-col justify-center">
                    ...
                    <div class="mt-10 flex flex-col sm:flex-col gap-4">
                        <a href="#" class="px-8 py-4 bg-[#f4a261] text-white text-center rounded-2xl font-semibold">For Corporates</a>
                        <a href="#" class="px-8 py-4 border border-gray-300 text-center hover:border-[#f4a261] rounded-2xl font-semibold transition-colors">Explore Our Collection</a>
                    </div>
                </div>
            </div>
        </div>
