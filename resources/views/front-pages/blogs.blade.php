        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-3">
                    Latest from <span class="text-[#f4a261]">B2B</span><span class="text-[#2ec4b6]"> Gifts</span><span
                    ...
                    <div
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center gap-3 text-xs text-gray-500 mb-3">
                                <span class="bg-orange-100 text-[#f4a261] px-3 py-1 rounded-full">Blog</span>
                                <span>{{ \Carbon\Carbon::parse($blog->created_at)->format('F d, Y') }}</span>
                            </div>

                            <!-- TITLE -->
                            <h3
                                class="text-xl font-semibold leading-tight mb-3 line-clamp-2 group-hover:text-[#f4a261] transition-colors">
                                {{ $blog->title }}
                            </h3>
                            ...
                            <a href="{{ route('blog.detail', $blog->slug) }}"
                                class="inline-flex items-center text-[#f4a261] font-medium hover:text-[#e07a5f] transition-colors">
                                Read Article →
                            </a>
