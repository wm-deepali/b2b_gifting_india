...
<section class="py-16 bg-gradient-to-r from-[#f4a261] to-[#e07a5f] text-white">
    <div class="max-w-4xl mx-auto px-6 text-center">
        ...
        <a href="javascript:void(0)" onclick="openGlobalDrawer('Start Your Customization Project', 'engraving_gallery')" class="inline-block bg-white text-[#e07a5f] px-12 py-5 rounded-2xl font-semibold text-lg hover:shadow-xl transition-all">
