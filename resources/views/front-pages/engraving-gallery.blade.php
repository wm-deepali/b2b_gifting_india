    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="text-center mt-16">
            <button onclick="alert('More engraving samples coming soon!')" 
                    class="px-10 py-4 border-2 border-[#f4a261] text-[#f4a261] font-semibold rounded-2xl hover:bg-[#f4a261] hover:text-white transition-all">
...
<section class="py-16 bg-gradient-to-r from-[#f4a261] to-[#e07a5f] text-white">
    <div class="max-w-4xl mx-auto px-6 text-center">
        ...
        <a href="#" class="inline-block bg-white text-[#e07a5f] px-12 py-5 rounded-2xl font-semibold text-lg hover:shadow-xl transition-all">
