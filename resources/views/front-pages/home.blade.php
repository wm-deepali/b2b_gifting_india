  ...
  <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-16 md:py-20 lg:py-24">
    <div class="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
      ...
      <div class="space-y-6 md:space-y-8">
        <div class="inline-flex items-center gap-3 bg-[#2ec4b6]/10 text-[#2ec4b6] px-5 py-2 rounded-full text-sm font-semibold tracking-wide">
          <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM4.707 8.707a1 1 0 011.414 0L9 11.586l5.293-5.293a1 1 0 111.414 1.414l-6 6a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414z" clip-rule="evenodd"/>
          </svg>
        ...
        <p class="text-lg sm:text-xl text-gray-700 font-light max-w-xl">
          Branded, customizable & thoughtful gifts for employees, clients & partners — delivered with your brand identity.
        </p>
        ...
        <div class="flex flex-wrap gap-6 pt-6 text-sm text-gray-600">
          <div class="flex items-center gap-2">
            <svg class="w-5 h-5 text-[#2ec4b6]" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM4.707 8.707a1 1 0 011.414 0L9 11.586l5.293-5.293a1 1 0 111.414 1.414l-6 6a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414z" clip-rule="evenodd"/></svg>
            Pan-India Delivery
          </div>
          <div class="flex items-center gap-2">
            <svg class="w-5 h-5 text-[#2ec4b6]" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM4.707 8.707a1 1 0 011.414 0L9 11.586l5.293-5.293a1 1 0 111.414 1.414l-6 6a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414z" clip-rule="evenodd"/></svg>
      ...
      <div class="relative mt-8 lg:mt-0">
        ...
        <img 
          ...
          loading="lazy"
          onerror="this.src='https://via.placeholder.com/800x520/2ec4b6/ffffff?text=Corporate+Gifts';"
        >
        <!-- Floating badge -->
        <div class="absolute -bottom-6 right-6 bg-white px-6 py-3 rounded-xl shadow-lg text-base font-semibold text-gray-800 flex items-center gap-2 border border-gray-100">
    ...
    <section class="bg-white py-20">
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex justify-between items-end mb-10">
                ...
                <a href="#" class="flex items-center gap-2 text-[#f4a261] font-medium">
                    View all categories 
            ...
            <div class="grid grid-cols-5 gap-6">
                ...
                <div onclick="window.location='#'" 
                    ...
                    <div class="p-6">
                        <h3 class="font-semibold text-xl">Executive Desk Sets</h3>
                        <p class="text-sm text-[#6b635a]">Premium leather &amp; metal</p>
                    </div>
                </div>
                ...
                <div onclick="window.location='#'" 
                     class="category-card bg-[#f8f4ed] rounded-3xl overflow-hidden cursor-pointer">
                    <img src="https://picsum.photos/id/201/400/280" 
                         class="w-full h-56 object-cover">
                    <div class="p-6">
                        <h3 class="font-semibold text-xl">Power Banks &amp; Tech</h3>
                        <p class="text-sm text-[#6b635a]">Branded &amp; fast charging</p>
                    </div>
                </div>
                ...
                <div onclick="window.location='#'" 
                    ...
                    <img src="2.JPG" 
                         class="w-full h-56 object-cover">
                    <div class="p-6">
                        <h3 class="font-semibold text-xl">Custom Notebooks</h3>
                        <p class="text-sm text-[#6b635a]">Laser engraved covers</p>
                    </div>
                </div>
                ...
                <div onclick="window.location='#'" 
                    ...
                    <img src="7.png" 
                         class="w-full h-56 object-cover">
                    <div class="p-6">
                        <h3 class="font-semibold text-xl">Eco Bamboo Gifts</h3>
                        <p class="text-sm text-[#6b635a]">Sustainable &amp; stylish</p>
                    </div>
                </div>
                ...
                <div onclick="window.location='#'" 
                    ...
                    <img src="5.png" 
                         class="w-full h-56 object-cover">
                    <div class="p-6">
                        <h3 class="font-semibold text-xl">Festive Hampers</h3>
                        <p class="text-sm text-[#6b635a]">Diwali &amp; New Year</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="max-w-7xl mx-auto px-6 py-24">
        <div class="grid md:grid-cols-2 gap-16 items-center">
            <div>
                <span class="inline-block bg-[#f4a261]/10 text-[#f4a261] px-6 py-2 rounded-full text-sm font-medium mb-6">Trusted by 5000+ Companies Across India</span>
                ...
                <p class="text-lg text-[#6b7280] mb-8">
                    B2B Gifts India specializes in high-quality, customizable corporate gifts that strengthen professional relationships. From executive desk accessories and branded tech to eco-friendly collections and luxury hampers — we deliver memorable experiences with your brand identity at the core.
                </p>
                <div class="flex gap-6">
                    <a href="#featured" class="bg-[#2ec4b6] text-white px-8 py-4 rounded-full font-semibold">Browse Gifts</a>
                    <a href="#contact" class="border-2 border-[#2d2d2d] text-[#2d2d2d] px-8 py-4 rounded-full font-semibold hover:bg-[#2d2d2d] hover:text-white transition">Get Quote</a>
                </div>
            </div>
            <img src="5.jpg" alt="Corporate Team" class="rounded-2xl shadow-2xl">
        </div>
    </section>
    ...
    <section id="shop-section" class="max-w-7xl mx-auto px-6 py-24">
        ...
        <div class="grid grid-cols-4 gap-8">
            ...
            <div class="product-card bg-white rounded-3xl overflow-hidden shadow-xl">
                <div class="relative">
                    <img src="https://picsum.photos/id/160/600/420" 
            ...
            <div class="product-card bg-white rounded-3xl overflow-hidden shadow-xl">
                <div class="relative">
                    <img src="https://picsum.photos/id/201/600/420" 
                         class="w-full h-72 object-cover">
                </div>
                <div class="p-6">
                    <div class="flex justify-between">
            ...
            <div class="product-card bg-white rounded-3xl overflow-hidden shadow-xl">
                <div class="relative">
                    <img src="https://picsum.photos/id/29/600/420" 
                         class="w-full h-72 object-cover">
            ...
            <div class="product-card bg-white rounded-3xl overflow-hidden shadow-xl">
                <div class="relative">
                    <img src="https://picsum.photos/id/318/600/420" 
                         class="w-full h-72 object-cover">
                </div>
                <div class="p-6">
                    <div class="flex justify-between">
...
<section class="max-w-7xl mx-auto px-6 py-8 bg-white overflow-hidden">
  <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
    ...
    <div class="lg:col-span-8 relative rounded-2xl overflow-hidden bg-gradient-to-br from-gray-50 to-white shadow-lg">
      <div class="absolute inset-0 bg-[url('https://pyxis.nymag.com/v1/imgs/e98/aac/983dc9aa8e221f7b6c888a35e30870f60e-DOTD-02-02-26.2x.rsocial.w600.jpg')] bg-cover bg-center opacity-30"></div>
      <div class="relative p-10 md:p-12 lg:p-16 flex flex-col justify-center h-full min-h-[380px] md:min-h-[420px]">
        ...
        <button class="w-fit bg-[#f4a261] hover:bg-[#e07a5f] text-white font-semibold px-8 py-4 rounded-full text-lg transition-all shadow-md hover:shadow-lg">
          Click Here →
        </button>
      </div>
    </div>
    ...
    <div class="lg:col-span-4 flex flex-col gap-5">
      ...
      <div class="bg-[#f0fdfa] rounded-xl p-5 shadow-md hover:shadow-lg transition-all">
        ...
        <div class="flex items-center gap-4">
          <img 
            src="https://cdn.mos.cms.futurecdn.net/B8wSMxeqLipsscckdRhdFi.jpg" 
            alt="GoPro Camera" 
            class="w-20 h-20 object-contain rounded-lg bg-white p-1 shadow-sm"
          >
          <div>
    ...
    <!-- Featured Products Section - Compact & Styled like your reference screenshot -->
  ...
  <div class="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
    ...
    <div class="group bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
      <div class="relative h-64 overflow-hidden">
        <img 
          src="https://picsum.photos/id/160/600/420" 
    ...
    <div class="group bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
      <div class="relative h-64 overflow-hidden">
        <img 
          src="https://picsum.photos/id/201/600/420" 
          alt="Apple Watch" 
          class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
        >
...
<section class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-16 bg-white">
  ...
  <div class="overflow-x-auto pb-6 scrollbar-hide snap-x snap-mandatory">
    <div class="flex gap-5 sm:gap-6 lg:gap-8 min-w-max px-1">
      ...
      <!-- Diwali -->
      <div class="min-w-[280px] sm:min-w-[300px] lg:min-w-[320px] snap-start group bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100">
  ...
  <div class="text-center mt-10">
    <a href="#" class="inline-flex items-center bg-gray-900 hover:bg-gray-800 text-white font-semibold px-8 py-4 rounded-full shadow-md transition-all duration-300">
  ...
  .scrollbar-hide::-webkit-scrollbar {
   ...
   <!-- FAQ -->
    <section class="max-w-4xl mx-auto px-6 py-24">
        <h2 class="text-4xl font-bold tracking-tighter text-center mb-16">Frequently Asked Questions</h2>
        ...
        <div class="space-y-4">
            <details class="group bg-white rounded-3xl p-8">
                ...
                <p class="mt-6 text-[#6b635a]">Minimum order starts from just 25 pieces for most products. We also offer special pricing for 100+ quantity orders.</p>
            </details>
            
            <details class="group bg-white rounded-3xl p-8">
                <summary class="flex justify-between items-center cursor-pointer font-semibold text-lg">
                    Do you provide logo customization?
                    <i class="fa-solid fa-plus group-open:rotate-45 transition-transform"></i>
                </summary>
                <p class="mt-6 text-[#6b635a]">Yes! Free logo printing / engraving on all products. We send digital proof within 24 hours.</p>
            </details>
            ...
            <details class="group bg-white rounded-3xl p-8">
                ...
                <p class="mt-6 text-[#6b635a]">Pan India delivery in 7-12 days. Express option available for Delhi-NCR in 3 days.</p>
            </details>
        </div>
    </section>
    ...
    <section id="contact-section" class="bg-[#f4f0e8] py-24">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-2 gap-16">
            ...
            <div>
                <h2 class="text-5xl font-bold tracking-tighter leading-none mb-8">Let's create something special for your brand</h2>
                <p class="text-[#6b635a] text-lg mb-10">Our team of gifting experts will help you choose the perfect combination that matches your budget and brand identity.</p>
            ...
            <form onsubmit="submitForm(event)" class="bg-white rounded-3xl p-10 shadow-xl">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <input type="text" placeholder="Your Name" class="border border-[#e0d6c7] focus:border-[#2ec4b6] rounded-2xl px-6 py-4">
                    <input type="email" placeholder="Business Email" class="border border-[#e0d6c7] focus:border-[#2ec4b6] rounded-2xl px-6 py-4">
                </div>
                
                <input type="text" placeholder="Company Name" class="mt-6 w-full border border-[#e0d6c7] focus:border-[#2ec4b6] rounded-2xl px-6 py-4">
...
<section class="bg-white py-16 border-t border-gray-100">
  <div class="max-w-7xl mx-auto px-6 text-center">
    ...
    <p class="text-lg text-gray-600 max-w-3xl mx-auto mb-12">
      We proudly collaborate with leading premium brands to bring you the highest quality corporate gifts, customized with your logo and delivered across India.
    </p>
  ...
  <img
    src="https://raw.githubusercontent.com/simple-icons/simple-icons/master/icons/apple.svg"
    alt="Apple"
...
<!-- Safari -->
        ...
        <div class="flex flex-col items-center min-w-[100px]">
          <img 
            src="https://upload.wikimedia.org/wikipedia/en/thumb/3/38/Cello_World.svg/250px-Cello_World.svg.png"
      alt="Cello" 
            class="h-10 md:h-12 grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all duration-300"
          >
        </div>
        ...
        <div class="flex flex-col items-center min-w-[100px]">
  <img 
    src="https://upload.wikimedia.org/wikipedia/commons/5/5e/Bose_logo.svg"
    alt="Bose" 
  ...
  >
       ...
       <div class="flex flex-col items-center min-w-[100px]">
  <img 
    src="https://upload.wikimedia.org/wikipedia/commons/0/02/Swiss_Army_logo.svg"
    alt="Swiss Military" 
    class="h-10 md:h-12 grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all duration-300"
  >
</div>
...
<section class="bg-gradient-to-b from-white to-[#f9f7f3] py-16 md:py-20">
  <div class="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
    ...
    <div class="relative overflow-hidden">
      ...
      <div class="flex gap-5 sm:gap-6 md:gap-8 overflow-x-auto snap-x snap-mandatory scrollbar-hide pb-6 -mx-5 sm:-mx-6 lg:-mx-8 px-5 sm:px-6 lg:px-8">
        
        <!-- Testimonial Card 1 – Portrait -->
        <div class="snap-start flex-shrink-0 w-[280px] sm:w-[320px] md:w-[360px] bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group">
          <div class="relative aspect-[9/16] overflow-hidden">
            <img 
              ...
              loading="lazy"
            >
            <div class="absolute inset-0 flex items-center justify-center bg-black/35 group-hover:bg-black/50 transition-all duration-300">
              <button class="w-20 h-20 md:w-24 md:h-24 bg-[#2ec4b6] rounded-full flex items-center justify-center shadow-2xl transform group-hover:scale-110 transition-transform duration-300 ring-4 ring-white/30">
          ...
          <div class="p-5 md:p-6">
            ...
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gray-200 flex items-center justify-center text-gray-600 font-bold text-sm md:text-base">
                SK
              </div>
              <div>
...
<div class="relative overflow-hidden w-full">
  ...
  <div class="marquee-wrapper flex whitespace-nowrap py-6">
    ...
    <div class="flex items-center gap-12 md:gap-16 lg:gap-20 px-4 shrink-0">
      ...
      <div class="client-logo">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Amazon_logo.svg/2560px-Amazon_logo.svg.png"
             alt="Amazon"
             class="h-8 md:h-10">
      </div>

      <div class="client-logo">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Microsoft_logo_(2022).svg/2560px-Microsoft_logo_(2022).svg.png"
             alt="Microsoft"
             class="h-8 md:h-10">
      </div>

      <div class="client-logo">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Tata_Consultancy_Services_Logo.svg/2560px-Tata_Consultancy_Services_Logo.svg.png"
             alt="TCS"
             class="h-10 md:h-12">
      </div>
    ...
    <div class="flex items-center gap-12 md:gap-16 lg:gap-20 px-4 shrink-0">
      ...
      <div class="client-logo"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/IBM_logo.svg/2560px-IBM_logo.svg.png" class="h-10 md:h-12"></div>
      <div class="client-logo"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/2560px-Google_2015_logo.svg.png" class="h-9 md:h-11"></div>
      <div class="client-logo"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Amazon_logo.svg/2560px-Amazon_logo.svg.png" class="h-8 md:h-10"></div>
      <div class="client-logo"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Microsoft_logo_(2022).svg/2560px-Microsoft_logo_(2022).svg.png" class="h-8 md:h-10"></div>
      <div class="client-logo"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Tata_Consultancy_Services_Logo.svg/2560px-Tata_Consultancy_Services_Logo.svg.png" class="h-10 md:h-12"></div>
      <div class="client-logo"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Accenture.svg/2560px-Accenture.svg.png" class="h-9 md:h-11"></div>
