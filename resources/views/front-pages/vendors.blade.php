...
<section class="py-20 bg-white">
    <div class="max-w-5xl mx-auto px-6">
        ...
        <div class="max-w-3xl mx-auto space-y-16 relative before:absolute before:left-8 before:top-10 before:bottom-10 before:w-0.5 before:bg-gradient-to-b before:from-[#f4a261] before:to-[#e07a5f]">

            <div class="process-step flex gap-10">
                <div class="w-16 h-16 bg-[#f4a261] text-white rounded-2xl flex items-center justify-center text-2xl font-bold flex-shrink-0" style="z-index: 10;">1</div>
                <div>
            ...
            <div class="process-step flex gap-10">
                <div class="w-16 h-16 bg-[#e07a5f] text-white rounded-2xl flex items-center justify-center text-2xl font-bold flex-shrink-0" style="z-index: 10;">3</div>
                <div>
        ...
        <div class="bg-white border border-gray-100 shadow-xl rounded-3xl p-10 md:p-14">
            ...
            <form>
                ...
                <div class="mt-8">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-2xl p-8 text-center hover:border-[#f4a261] transition-colors cursor-pointer">
