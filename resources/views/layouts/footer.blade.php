...
<div class="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 shadow-md md:hidden z-[999]">
  ...
  <div class="grid grid-cols-5 text-center text-xs">
    ...
    <!-- Home -->
    <a href="{{ route('home') }}"
      class="flex flex-col items-center justify-center py-2 text-gray-600 hover:text-[#f4a261]">
      ...
      <div class="col-span-2 sm:col-span-3 lg:col-span-1">
        <div class="flex items-center gap-3 mb-6">
          <div class="font-bold text-2xl lg:text-3xl tracking-tight">
            <span class="text-[#f4a261]">B2B</span>
            <span class="text-[#2ec4b6]">Gifts</span>
            <span class="text-[#e07a5f]">India</span>
          </div>
        </div>
